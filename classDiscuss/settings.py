...
STATICFILES_DIRS = ( # Additional locations of static files
    '/home/ubuntu/classDiscuss/classDiscuss/static/',
)
...
SECRET_KEY = '4udtk3*s)m_ft9s%@q2@am+y#nn*mb+-g9z6vrmjx43+y0k$$@'
...
ROOT_URLCONF = 'classDiscuss.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'classDiscuss.wsgi.application'
